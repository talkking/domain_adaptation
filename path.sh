...
export PATH=$PATH:~/tools/SRILM
# NOTICE: Get the location of scripts dir, under the assumption that this file is
# located at ASR_ROOT/asr/scripts/
PYTORCH_ASR_ROOT=$PWD/tools/pytorch-asr
#PYTORCH_ASR_ROOT=/mnt/lustre/aifs/home/tt321/src/pytorch-asr #$PWD/tools/pytorch-asr
#/mnt/lustre/aifs/home/tt321/src/pytorch-asr  #$PWD/tools/pytorch-asr
#/mnt/lustre02/jiangsu/aispeech/home/hs418/pytorch-asr
#/mnt/lustre/aifs/home/tt321/src/pytorch-asr
...
export PYTHONPATH=$PYTHONPATH:extend_codes
